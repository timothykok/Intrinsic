...
export default function Financials() {
  ...
  useEffect(() => {
    ...
    const fetchFiveYearGrowthRate = async () => {
        try{
            const response = await axios.get("https://www.alphavantage.co/query?function=EARNINGS&symbol=AAPL&apikey=496Z5WWYIJYB3MFM"
            ...
            console.error("Error fetching 5 year growth rate")
        }
    }
