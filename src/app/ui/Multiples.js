...
export default function Multiples({
  ...
  return (
    <div className="multiples-calculation max-w-[800px] mx-auto pt-12 pb-12 mt-8 uppercase text-sm text-[#626262]">
      ...
      {/* Net Income */}
      <div className="flex justify-between items-center mb-6">
        <span className="ml-4 w-80">EPS</span>
        <span className="text-right">
          <div className="flex items-center">
            <span className="mr-2">{currency}</span>
            <span className="w-48">
      ...
      <div className="flex justify-between items-center mb-6">
        <span className="ml-4 w-80">Industry P/E </span>
        <div className="flex items-center">
      ...
      <div className="flex justify-between items-center">
        <span className="ml-4 w-80">Intrinsic Value per Share</span>
        <span className="text-right">
          <div className="flex items-center">
            <span className="mr-2">{currency}</span>
            <span className="w-48">
